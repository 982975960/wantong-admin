<#--用来创建和编辑书本信息使用的-->
  ...
  <div class="popups-con" style="padding:0; width:100%;">
    <div class="popups-b">
      ...
      <ul class="work-list-top">
        <li>
            <span style=" width:20%;">
              <input name="text" type="text" id="isbn" value="${book.isbn!}" maxlength="13" <#if (book.isbn != "")>disabled</#if>
  ...
  <#--保存和取消按钮组-->
    <div class="btn-group popups-bot" style="float: right;margin-top: 10px;padding-right: 10px;margin-bottom: 20px;padding-top: 20px;">
        ...
        <span>
          <input type="button" class="pop-padding frame-Button-b Button-left confirm-button" tid="0" value="加入工单" />
        </span>
