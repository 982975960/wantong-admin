<@script src="/js/base/fingerBook.js"></@script>
<@script src="/js/base/finger.js"></@script>
<@link href="/css/base/fingerBook.css" rel="stylesheet"/>
<div id="fingerBookDiv">
  <div>
    <label>单击鼠标并拖动产生矩形框，将图中书本涵盖在矩形框内</label>
    <label style="margin-top: 5px">(完整涵盖书本，尽少的涵盖其他区域)</label>
  </div>
