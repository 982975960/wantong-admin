wantong.cms.searchLabel = (function () {
    var
    _root = null,
    _config = {},
    ...
    _initBtn = function() {
        ...
        //  设置label名称  和Id 切关闭layer
            ...
            if(labelIds.length <= 0){
                wantong.cms.booklist_resource.closeLabelLayer(labelIdAll,labelNameAll,inputLabelName);
            } else {
                wantong.cms.booklist_resource.closeLabelLayer(labelIdAll,labelNameAll,"");
            }

        });
        //关闭layer
        _root.find("#closeBtn").off("click").on("click",function () {
            wantong.cms.booklist_resource.closeLabelLayer();
        });
     },
