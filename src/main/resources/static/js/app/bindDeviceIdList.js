wantong.bindDeviceIdList = (function () {
  var SHOW_DEVICEID_LIST_URL = GlobalVar.contextPath
      + "/app/showDeivceIdList.do",
      _root = null,
      _conf = {},
      _init = function (conf) {
        $.extend(_conf, conf);
        _root = $("#bindDeviceIdListDiv");
        if ($("#bindDeviceIdListDiv").find("#pagination").length > 0) {
          _initPagination($("#bindDeviceIdListDiv").find("#pagination"));
        }
      ...
      _refreshList = function (page) {
        ...
        $.get(SHOW_DEVICEID_LIST_URL, {
          currentPage: page,
          searchText: searchText,
          recordId: _conf.recordId
        }, function (data) {
          $("#bindDeviceIdListDiv").html(data);
        });
      },
