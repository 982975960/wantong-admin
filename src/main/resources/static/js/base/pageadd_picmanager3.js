wantong.base.pageAdd.picManager3 = (function () {
  var
      _root = null,
      _coverImage = null,
      _conf = {
      ...
      _initDragImg = function () {
        var previewImgDiv = document.getElementById("previewImgDiv3");
      ...
      _initUploadButton = function () {
        ...
        wantong.base.booklist.bindUploaderValidator(_uploader, 'c');
