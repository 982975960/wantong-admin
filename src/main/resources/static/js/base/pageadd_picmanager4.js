wantong.base.pageAdd.picManager4 = (function () {
  var
      _root = null,
      _coverImage = null,
      _conf = {
      ...
      _initAuth  = function(){
        _authorityManagement.uploadImage = JSON.parse(_root.find("#uploadButton").attr("isAuthority"));
      },
      ...
      _initDragImg = function () {
        var previewImgDiv = document.getElementById("previewImgDiv4");
      ...
      _uploadImg = function (file) {//上传图片，拖拽图片的方式上传图片
        ...
        $.ajax({
          url: _conf.UPLOAD_URL + "?check=" + true,
          type: 'POST',
          cache: false,
          data: formData,
          processData: false,
      ...
      _initUploadButton = function () {
        ...
        _root.mouseover(function () {
          ...
          /*if(_authorityManagement.uploadImage) {
            ...
            bigButton.css("margin-left","85px");
          }*/
          bigButton.show();
          btnBg.show();
        }).mouseout(function () {
        ...
        wantong.base.booklist.bindUploaderValidator(_uploader, 'd');
