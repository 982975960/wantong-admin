wantong.base.pageAdd.picManager2 = (function () {
  var
      _root = null,
      _coverImage = null,
      _conf = {
      ...
      _initDragImg = function () {
        var previewImgDiv = document.getElementById("previewImgDiv2");
      ...
      _initUploadButton = function () {
        ...
        _root.mouseover(function () {
          ...
          /*if(_authorityManagement.uploadImage) {
            ...
            bigButton.css("margin-left","70px");
          }*/
          bigButton.show();
          btnBg.show();
        }).mouseout(function () {
        ...
        wantong.base.booklist.bindUploaderValidator(_uploader, 'b');
