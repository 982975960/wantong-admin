...
public class DashboardApiController extends BaseController {
     ...
     */
    @GetMapping("setup")
    public Object setup(@RequestParam(value = "type", required = false, defaultValue = "0") Integer type,
        ...
        return dashboardApiBiz.setup(getAdminSession(), type, minDate, maxDate);
    }
